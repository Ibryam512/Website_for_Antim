<html>
    ...
    <body>
        ...
        <div style="text-align: center;">
            ...
            <input style="text-align: center; font-size: xx-large;" disabled value="Иван" id="disabled" type="text" class="validate">
        </div>
        <div style="text-align: center;">
        ...
        <div style="text-align: center;">
            ...
            <input style="text-align: center;font-size: xx-large;" disabled value="@@@@@@" id="disabled" type="text" class="validate">
        </div>
        <div style="text-align: center;margin-bottom: 50;">
            <label for="disabled">Имейл</label>
            <input style="text-align: center;font-size: xx-large;" disabled value="аз.аз@аз.аз" id="disabled" type="text" class="validate">
        </div>
    </body>
</html>