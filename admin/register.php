      ...
      <div class="card col m4 offset-m4">
        <div class="card-content">
          <form  action="" method="POST" class="col s12">
            <h1>Регистрация на админ</h1>
            <div class="row">
              <?php
                //свързвеаме се с базата данни
                if(!isset($_SESSION['admin']) || $_SESSION['ID'] != 6)
                {
                  echo "Само собствениците на сайта могат да регистрират други потребители";
                  return;
                }
                include 'connect.php';
                $conn=OpenCon();
                ...
                if(isset($_POST['email'])&&isset($_POST['password'])&&isset($_POST['name'])&&isset($_POST['secName'])&&isset($_POST['lastName']))
                {
                  ...
                  if($mom == false){
                    ...
                    $sql="INSERT INTO `admins`(`email`, `password`, `name`, `secName`, `lastName`) VALUES ('$email','$password','$name','$secName','$lastName')";
